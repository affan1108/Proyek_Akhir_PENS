...
Route::middleware('auth')->group(function () {
    ...
    Route::post('logout', [AuthenticatedSessionController::class, 'destroy'])
                ->name('logout');
    Route::get('/katalog', [App\Http\Controllers\MenuController::class, 'katalog'])->name('katalog');
...
// Route::group(['middleware' => ['auth','role:admin']], function () {
    ...
    Route::get('/report', [App\Http\Controllers\MenuController::class, 'report'])->name('report');
    Route::get('/payment', [App\Http\Controllers\MenuController::class, 'payment'])->name('tables.payment');
